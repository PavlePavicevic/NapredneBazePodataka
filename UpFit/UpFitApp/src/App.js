    ...
    <div className="App">
      <ThemeProvider theme={theme}>
        <Routes>
          ...
          />
          <Route
            path="/DeletedExercise"
            element={
              <Header
                Component={DeletedExercisePage}
                ThemeHandler={colorMode.toggleColorMode}
              />
            }
          />
