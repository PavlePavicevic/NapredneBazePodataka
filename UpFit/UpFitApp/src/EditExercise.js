...
export default function EditExerciseDialog({ currentTitle, currentDescription, update,id }) {
    ...
    const handleSubmit = () => {
        let fetchreq = "http://localhost:5211/api/Exercise/UpdateExercise/"+id+"/"+title+"/"+description;
