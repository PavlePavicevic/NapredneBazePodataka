...
export default function References() {
    ...
    const [exercises, setexercises] = React.useState([ //ucitavanje iz baze
        // { id: 0, name: 'Angular' },
        // { id: 1, name: 'jQuery' },
        // { id: 2, name: 'Polymer' },
        // { id: 3, name: 'React' },
    ...
    const getexercises = async () => {
        ...
        const response = await fetch("http://localhost:5211/api/Category/GetCategoryexercises?" + categoriesQuery);
        if (response.ok) {
            ...
            <Grid container spacing={3} sx={{ mb: 4 }}>
                ...
                <Grid item xs={12} >
                    ...
                    <Paper
                        ...
                        variant="outlined"
                    >
                        <ExerciseTransferList exercises={exercises} leftTitle={"Available exercises:"}
